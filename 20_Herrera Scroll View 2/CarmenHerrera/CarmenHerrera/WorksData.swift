...
let worksArray = [
    Work(title: "Blanco y Verde",
        ...
        referenceString: "https://whitney.org/Exhibitions/CarmenHerrera#exhibition-artworks"
    ),
    Work(title: "Rondo (Blue and Yellow)",
        ...
        referenceString: "https://www.si.edu/object/rondo-blue-and-yellow:hmsg_07.94"
    ),
    Work(title: "Unknown",
         ...
         medium: nil,
         collection: nil,
         referenceString: "https://mobile.twitter.com/womensart1/status/1305507366255955969"
    ),
    Work(title: "Untitled",
         ...
         referenceString: "https://www.moma.org/collection/works/101471"
    ),
    Work(title: "untitled",
         ...
         collection: "MOMA, Gift of Agnes Gund and Tony Bechara",
         referenceString: "https://www.artsy.net/artwork/carmen-herrera-untitled-20"
    )
]
